...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "views/hex_view.py"

        #Name of program
        self.project_name = "Binary Tactics: Battle Demo DO NOT REDISTRIBUTE"

        #Project url
        self.project_url = "https://github.com/AFDudley/btpy"
    ...
    def run(self):
        ...
        setup(
            ...
            options = {'py2exe': {'optimize': 2, 'bundle_files': 1, 'compressed': True, \
                                  ...
                                  'includes': self.includes, 'dll_excludes': self.exclude_dll} },
...
if __name__ == '__main__':
    ...
    #hack
    shutil.move(os.path.join('dist','hex_view.exe'),os.path.join('dist','hex_view_DO_NOT_REDISTRIBUTE.exe'))
    os.makedirs(os.path.join('dist','views'))
    shutil.move(os.path.join('dist','DroidSansMono.ttf'),os.path.join('dist','views','DroidSansMono.ttf'))
