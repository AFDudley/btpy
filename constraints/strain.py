...
ugh.addVariable("value", valuesize)
#there has got to be an easier way of doing this
ugh.addConstraint(lambda suit, E, F, I, W: (suit == 1 and E > 0 and W < 1)  \
                                        or (suit == 2 and F > 0 and I < 1)  \
                                        or (suit == 3 and I > 0 and F < 1)  \
                                        or (suit == 4 and W > 0 and E < 1), \
                                        ["suit", "E", "F", "I", "W"])

ugh.addConstraint(lambda E, F, I, W, value: value == E + F + W + I, ["E","F","I","W","value"])

ugh.addVariable("str", ten)
ugh.addConstraint(lambda E, F, I, W, str: str == (2 * (E + F)) + I + W, ["E","F","I","W","str"])

ugh.addVariable("int", ten)
ugh.addConstraint(lambda E, F, I, W, int: int == (2 * (I + W)) + E + F, ["E","F","I","W","int"])

ugh.addVariable("PDEF", ten)
ugh.addConstraint(lambda E, F, I, W, str, PDEF: PDEF == E + str, ["E", "F", "I", "W", "str", "PDEF"])

ugh.addVariable("PATK", ten)
ugh.addConstraint(lambda E, F, I, W, str, PATK: PATK == F + str, ["E", "F", "I", "W", "str", "PATK"])
