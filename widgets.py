...
class MessageBoard(object):
    """ A rectangular "board" for displaying messages on the 
        screen. Uses a Pane with text drawn inside.
    ...
    def __init__(self, 
        ...
        """ rect, bgcolor, border_width, border_color have the 
            same meaning as in the Pane widget.
        ...
        self.box = Pane(surface, rect, bgcolor, border_width, border_color)
...
if __name__ == "__main__":
    ...
    box = Pane(screen, Rect(20, 20, 40, 40), Color('brown4'), 0, Color('red'))
